...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        <div className='match_history'>
            <div className='win'>
                <div className='match_infos'>{userInfo.gameHistory[0] && userInfo.gameHistory[0].opponentUser ? userInfo.gameHistory[0].opponentUser.name : 'EnemyName'}</div>
                <div className='match_infos'>{userInfo.gameHistory[0] && userInfo.gameHistory[0].ScorePlayer1 ? userInfo.gameHistory[0].ScorePlayer1 : 'MyScore'} - {userInfo.gameHistory[0] && userInfo.gameHistory[0].ScorePlayer2 ? userInfo.gameHistory[0].ScorePlayer2 : 'EnemyScore'}</div>
